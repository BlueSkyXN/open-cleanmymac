...
| 01 | [扫描引擎](01-scan-engine.md) | 任务图、加权进度聚合、暂停/恢复/取消 | 🟡 通用 DAG、并发、加权进度、快照和共享三态协作控制已落；Countable total、每任务 Control 聚合/observer 未落 |
| 02 | [扫描点字典](02-scan-points.md) | ⭐ 所有"扫哪里"：路径、模式、安全等级 | 🟡 公开 CLI 的保守子集和项目/空间扫描已落；并非内部/System Junk 字典逐项全覆盖 |
...
| 00 命令树 / 06 流程 | `openclean/cli.py`、`redaction.py`、`cleanup.py`、`tui.py`、`space_tui.py` | `optimize`、特权 XPC |
